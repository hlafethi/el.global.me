...
export const siteConfig = {
  name: 'E & L PROPRETE',
  description: 'Entreprise de nettoyage à Lyon et son agglomération. Services de propreté pour professionnels et particuliers dans la métropole de Lyon et le Rhône.',
